    ...
    : logHelper(Poco::Logger::get("TestLogger"))
{
    ...
    Poco::FormattingChannel* pFormattingChannel = new Poco::FormattingChannel(new Poco::PatternFormatter("%Y-%m-%d %H:%M:%S.%c %N[%P]:%s:%q:%t"));
    pFormattingChannel->setChannel(new Poco::ConsoleChannel());
