    ...
    : logHelper(Poco::Logger::get("TestLogger"))
{
    ...
    Poco::AutoPtr<Poco::Util::FileChannel> pFileChannel = new Poco::Util::FileChannel("/tmp/meeting-sdk-linux-sample/out/received_data.txt");
    pFileChannel->setProperty("path", "/tmp/meeting-sdk-linux-sample/out/received_data.txt");

    Poco::AutoPtr<Poco::Util::FormattingChannel> pFormattingChannel = new Poco::Util::FormattingChannel(pPatternFormatter, pConsoleChannel);
